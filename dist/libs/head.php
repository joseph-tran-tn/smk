...
<meta name="twitter:title" content="Life Designs（ライフデザインズ）｜東海の暮らしのウェブマガジン">
...
<link href="<?php echo APP_ASSETS; ?>css/custom.css?v=<?php echo time() ?>" rel="stylesheet" media="all">
<!--/css-->
