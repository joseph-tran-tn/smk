...
<body id="contact" class='contact'>
  ...
  // Send mail
    if(isset($_POST['submit'])){
      $to = "quyld@alive-web.co.jp"; // this is your Email address
      $from = $_POST['email']; // this is the sender's Email address
      $reg_name = $_POST['username'];
      $reg_tel = $_POST['tel'];
      $reg_ms = $_POST['txtcomment'];
      ...
      // More headers
      $headers .= 'From: quyld@alive-web.co.jp' . "\r\n";
      $headers .= 'Cc: quyld@alive-web.co.jp' . "\r\n";
